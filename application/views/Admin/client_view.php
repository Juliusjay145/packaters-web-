        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <td class="text-center"><a href="<?php echo base_url('AdminController/deactivate_client')?>/<?php echo $c['id']; ?>" class="btn btn-danger btn-lg btn3d"><span class="glyphicon glyphicon-remove"></span> <?php echo $c['status'];?></a></td>
                                </tr>
