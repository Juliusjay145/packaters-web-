...
<body>
    <div class="container h-100" style="margin-top: 100px">
        <div class="d-flex justify-content-center h-100">
            <div class="user_cardplat" style="margin-top: 10px">
                ...
                <div class="d-flex justify-content-center form_container">
                    <!-- forms -->
                    <form id="login-form" class="form" action="<?php echo base_url('CateringController/add_register_platinum')?>" method="post">
                            <h3 class="text-center textcolor" style="margin-top: 80px;">Platimum Catering Provider Register</h3>
