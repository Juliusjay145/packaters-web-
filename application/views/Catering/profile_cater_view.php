                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="<?php echo base_url('CateringController/update')?>" method="post">
                                        <input type="hidden" name="id" class="form-control" value="<?php echo $cater[0]['id']; ?>">
                                        <div class="form-group">
                                            <label>Catering Name</label>
                                            <input class="form-control" name="cat_name" placeholder="Enter text" value="<?php echo $cater[0]['cat_name']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input class="form-control" name="cat_address" placeholder="Enter text" value="<?php echo $cater[0]['cat_address']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Contact Number</label>
                                            <input class="form-control" name="cat_contactno" placeholder="Enter text" value="<?php echo $cater[0]['cat_contactno']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" name="cat_details" rows="3"><?php echo $cater[0]['cat_details']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Old password</label>
                                            <input type="password" class="form-control" name="cat_password" value="<?php echo $cater[0]['password']; ?>">
                                        </div>
                                        <div class="form-group">
