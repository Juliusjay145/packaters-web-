...
<body>
    <div class="container h-100" style="margin-top: 100px">
        <div class="d-flex justify-content-center h-100">
            <div class="user_cardcustomerreg" style="margin-top: 10px">
                ...
                <div class="d-flex justify-content-center form_container">
                    <!-- forms -->
                    <form id="login-form theFormID" class="form" action="<?php echo base_url('CustomerController/add_register')?>" method="post">
                            <h3 class="text-center textcolor">Registration Form for Customer</h3>
