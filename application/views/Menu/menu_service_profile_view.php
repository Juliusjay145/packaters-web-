                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="<?php echo base_url('CategoryController/update')?>" method="post">
                                        <input type="hidden" name="id" class="form-control" value="<?php echo $menu[0]['id']; ?>">
                                        <div class="form-group">
                                            <label>Catering Name</label>
                                            <input class="form-control" name="menu_name" placeholder="Enter text" value="<?php echo $menu[0]['menu_name']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" name="menu_details" rows="3"><?php echo $menu[0]['menu_description']; ?></textarea>
                                        </div>
